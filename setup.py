    ...
    def run(self):
        ...
        try:
            subprocess.check_call(
                ['git', 'clone', 'https://github.com/rejuvyesh/HFO.git', 'hfo_py'])
...
setup(name='hfo-py', version='0.2', author='Matthew Hausknecht',
      author_email='matthew.hausknecht@gmail.com',
      description='Half Field Offense in 2D RoboCup Soccer.', packages=['hfo_py'],
      cmdclass={'build': Build}, include_package_data=True)
